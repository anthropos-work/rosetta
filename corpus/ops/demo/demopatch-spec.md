...
>    *(A directory-driven fence would prevent this class of drift; the `demo_knob_guard`-style sweep that catches
>    knob drift does not yet cover the patch-manifest inventory — a standing hygiene gap.)*
