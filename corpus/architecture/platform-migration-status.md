...
| `hyper-studio` | 2026-08-06 | the org's most actively developed repo (827 commits since 2026-06-17) — the successor to **studio-room**, **PRE-INTEGRATION** (zero platform coupling, no deployment). `secrets-spec.md:344` already borrows its `.env.example`. [`org-repos.md` § 10](org-repos.md) |
...
|---|---|---|
| repos `repos.yml` declares (`app`, `sentinel`, `next-web-app`, `studio-desk`) | **fenced** A/B | **prose-under-review** — `live-standalone` is asserted, not derived |
