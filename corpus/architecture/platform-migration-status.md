...
| `infrastructure` | 2026-08-07 | **the Terraform monorepo — the platform's authoritative deployment ledger, and it was never in a clone set.** Reading it at iter-123 settled the `cms` row above. Mutually pinned with 9 service repos. [`org-repos.md` § 3](org-repos.md) |
