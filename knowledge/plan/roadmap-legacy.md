# Roadmap — Legacy (v1.x, the demo/seeding major)

> **This is the RETIRED v1.x history.** When **v2.0 "opening night"** opened (a NEW MAJOR — the
> **Playthroughs** pillar) on **2026-06-28**, the whole of **v1.0 … v1.10 (all SHIPPED)** rotated out of the
> active [`roadmap.md`](roadmap.md) into this legacy file, faithfully preserved. The active roadmap now holds
> **v2.0** only; consult this file for any v1.x milestone detail (M0 … M46), the v1.x version-plan table, and
> the v1.x Done/Shipped/Notes sections. Nothing here is in development — every line is tagged + merged + archived
> under [`releases/archive/`](releases/archive/). _(See `roadmap.md` for the live v2.0 plan and
> [`roadmap-vision.md`](roadmap-vision.md) for the future-milestone backlog.)_

The text below is the v1.x roadmap exactly as it stood at v1.10 close (2026-06-27) — preserved verbatim.

---

# Roadmap (v1.x — historical)

Active development plan for **Project Rosetta** (the Anthropos documentation corpus + environment-
builder skills). _(v1.x — historical; the live plan is `roadmap.md`.)_
