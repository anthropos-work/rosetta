...
**Status (2026-07-13):** **v2.3 "cue to cue" IN DEVELOPMENT** — the **presenter-speed release** (branch
`release/02.30-cue-to-cue`, designed 2026-07-13 via `/developer-kit:design-roadmap`; **5 milestones M217 →
{ M218 ∥ M219 ∥ M220 } → M221**; tag `v2.3`). A **field-hardening release** (the v1.3b / v1.10b / v2.1 lineage)
...
**Active:** **v2.3 "cue to cue" IN DEVELOPMENT** (branch `release/02.30-cue-to-cue`, cut from `main` 2026-07-13;
tag will be `v2.3`). The **presenter-speed release** — *a presenter swaps heroes in under 5 seconds, on a demo that
