...
## Deliverables
- [ ] Compliant `.agentspace/secrets` dir assembled from current stack-dev (names-correct, alias-mapped, knowns waived)
- [ ] `provision` into a fresh `dev-N` → `measure` Critical == 100%
- [ ] `provision` into a fresh `demo-N` → `measure` Critical == 100% (demo-aware: Clerk minted-OK)
