...
# ADDENDUM — readings #21 / #22 (M257x iter-99), 2026-08-06
...
`corpus/services/**` + `corpus/architecture/**` — **40 files, 10,276 lines**, partitioned across 7 seats.
Two independent readings of the identical partition (#21 and #22). You are one blind seat: you do not know
which reading you are in, and you must not seek out any other seat's output.

## One thing that is TRUE and worth knowing

The corpus was repaired **at the immediately preceding commit** (37 sites across 22 files). Repairs
