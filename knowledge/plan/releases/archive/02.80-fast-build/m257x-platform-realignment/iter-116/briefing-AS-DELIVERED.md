...
# ADDENDUM — readings #29 / #30 (M257x iter-116), 2026-08-07
...
**Every clone above is at the SAME sha it was at the previous TWO readings.** No repo has advanced since
iter-103's reading. That is a property of this reading, not a reason to relax: **the previous reading
proved that a claim can be false against a sha that never moved** — platform-drift was ~33 % of its
residual over a subject in which literally nothing changed.
...
| authoring copy | `.agentspace/rosetta-extensions` | **`1dc1eb82`** on `main` |
...
Two independent readings of the identical partition (#29 and #30). You are one blind seat: you do not know
which reading you are in, and you must not seek out any other seat's output.

## One thing that is TRUE and worth knowing

The corpus was **repaired at a recent commit, and this repair was bigger and differently scoped than the
last one**: **24 distinct false propositions closed at 71 sites**, where the site list was enumerated from
**the whole corpus per proposition** rather than from what a previous audit happened to detect. The
in-scope corpus grew **10,694 → 10,871 lines**. **Do not treat recently-edited prose as safer; if anything
treat it as more suspect** — every prior reading has measured repair-induced defects, and the repair itself
had to fix four of its own line anchors mid-flight. Equally, do not book a claim merely because it looks
new, and do not book a *retraction* merely because it contradicts the thing it retracts — a retraction
saying "X was wrong, the truth is Y" is correct prose, not a self-contradiction.
...
and the sentence is true at the ref it names. Graded and routed at this reading's open. It is stated here
so that a seat which independently notices it books what it measured, not what a guard said.
