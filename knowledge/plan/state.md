...
phase: "v2.4 RE-OPENED for believability. M222→M227 closed (M227 = the 4 believability seed/content fixes + gate retune, deterministically proven; live re-prove routed to M228). NEXT: M228 second-night = the corrected-demo billion re-prove → then the USER's /developer-kit:close-release. NOT tagged until user sign-off."
