...
`roadmap-vision.md`). The unscheduled backlog (M33 ant-academy liveness, DEF-M10-01, DEF-M21-01..04, M25-D9)
is candidate input.
...
`stack-demo/`; the literal browser-pixels `DEMO_STORIES=1` cockpit end-to-end (a deliberate demo step);
...
[orchestrator's step]. **Next: `/developer-kit:design-roadmap`.** Prior: v1.8 "understudy" SHIPPED 2026-06-15.)_
