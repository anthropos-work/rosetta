...
**iter-104 turned that into `TOK-06: fence the inflows before repairing again`** — a **deliberate**
(author-initiated, non-terminating) tok; the 3-no-prog streak was checked and does **not** apply. It changes
