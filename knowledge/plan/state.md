...
active_milestone: "M250 AI-readiness fidelity (ITERATIVE marquee; 31 real skills + 2 named sims + evaluated-skills set-dress + skill distribution; render->measure->fix loop on the single stack)"
