...
> **v1.2 "set dressing"** → `roadmap.md` 2026-06-05 (now in development on `release/01.20-set-dressing`; the
> **snapshot mechanism** — lift M7c's `waived` taxonomy + content to 100% coverage).
...
_Last updated: 2026-06-05 (v1.2 "set dressing" promoted to roadmap.md — the snapshot mechanism; AI-content +
shareability + more-mirrors held as v1.3 seeds)._
