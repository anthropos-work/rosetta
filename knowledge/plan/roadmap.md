...
| **v1.3b** | **dress rehearsal** | Field-hardening — make `/demo-up` produce a full, populated, verified, demoable stack (the gaps the first real run surfaced) | M16 ✅ → M17 ✅ → M18 → M19 → M20 | 🚧 **IN DEVELOPMENT** (designed 2026-06-08; M17 closed 2026-06-09) |
