...
| **v1.2** | **set dressing** | Richer demo worlds — the real *public* taxonomy + content library, measured-faithful, to 100% data-DNA coverage | M9a ✅ → M9b ✅ → M10 ✅ → M11 ✅ | 🚧 **ALL MILESTONES CLOSED** — ready for `/developer-kit:close-release` (`release/01.20-set-dressing`) |
