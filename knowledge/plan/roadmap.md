...
>
> **v1.3 "stack party" — ALL 4 MILESTONES DONE, READY FOR `/developer-kit:close-release`** (designed + built
> 2026-06-07 on `release/01.30-stack-party`; M12→M15 all closed). 4 milestones
...
| **v1.3** | **stack party** | dev + demo stacks as first-class peers — local Directus, auto-snapshot + light seed, smart shared ports, one unified `stack-*` skill set | M12 ✅ → M13 ✅ → M14 ✅ → M15 ✅ | ✅ **ALL MILESTONES DONE — READY FOR `/developer-kit:close-release`** (`release/01.30-stack-party`; merges → `main`, tags `v1.3`) |
