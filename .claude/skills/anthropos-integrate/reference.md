...
| `corpus/setup/setup_guide.md` | Setup instructions | New setup step |
| `corpus/setup/setup_checklist_macos.md` | macOS progress | Setup structure change |
| `corpus/setup/setup_checklist_linux.md` | Linux progress | Setup structure change |
...
Documentation Impact:
  ...
  - Update: corpus/setup/setup_guide.md (clone + migrations)
...
Documentation Impact:
  ...
  - Update: corpus/architecture/service_taxonomy.md
  - Update: corpus/setup/setup_guide.md (pip install steps)
```
...
Documentation Impact:
  - Update: corpus/setup/setup_guide.md
