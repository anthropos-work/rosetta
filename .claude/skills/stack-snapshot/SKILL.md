...
> **Skiller→app merge (July 2026), taxonomy surface re-grounded (v2.1 M209).** The standalone `skiller`
> service was merged into `app`; app's migrations now create the taxonomy tables in the **`public` schema**, so
